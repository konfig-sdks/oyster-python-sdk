...
from oyster_python_sdk.model.departments_get_all_response import DepartmentsGetAllResponse as DepartmentsGetAllResponseSchema
from oyster_python_sdk.model.error import Error as ErrorSchema

from oyster_python_sdk.type.error import Error
from oyster_python_sdk.type.departments_get_all_response import DepartmentsGetAllResponse

from ...api_client import Dictionary
from oyster_python_sdk.pydantic.departments_get_all_response import DepartmentsGetAllResponse as DepartmentsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DepartmentsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DepartmentsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DepartmentsGetAllResponsePydantic:
        ...
        if validate:
            return DepartmentsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DepartmentsGetAllResponsePydantic, raw_response.body)
