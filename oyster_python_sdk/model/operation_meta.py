...
class OperationMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["completed", "success", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["completed", "success", ], str]):
