...
class OperationRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            queryParams = schemas.DictSchema
            responseCode = schemas.IntSchema
            __annotations__ = {
                "method": method,
                "path": path,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["method", "path", "queryParams", "responseCode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["method", "path", "queryParams", "responseCode", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        responseCode: typing.Union[MetaOapg.properties.responseCode, decimal.Decimal, int, schemas.Unset] = schemas.unset,
